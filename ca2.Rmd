...
We see that the two figures are pretty much identical. We also note from the Kaplan-Meier curves that the assumption of proportional hazards seems to be somewhat fulfilled as the effect of Type seems to be somewhat constant over time (ignoring the endpoints of the interval).
