...
We see from the figure above that $H_0$ can be rejected on the 5%-level as $Z_1(t_0)$ exceeds $\Phi(0.975)$. Next up is a to fit a Cox regression model to our data.
